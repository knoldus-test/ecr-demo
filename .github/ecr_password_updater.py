...
if __name__ == '__main__':
    ...
    get_public_key = requests.get(f'https://api.github.com/repos/ORG/REPOSITORY/actions/secrets/public-key',
                                  headers={'Accept': 'application/vnd.github.v3+json',
                                           'Authorization': 'token ' + os.environ['GIT_HUB_API_ACCESS_TOKEN']})
    ...
    update_password = requests.put('https://api.github.com/repos/knoldus-test/ecr-demo/actions/secrets/ECR_PASSWORD',
                                   headers={'Accept': 'application/vnd.github.v3+json',
                                            'Authorization': 'token ' + os.environ['GIT_HUB_API_ACCESS_TOKEN']},
